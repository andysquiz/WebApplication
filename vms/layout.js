wsq.controls.layout = function (template, data, parent) {
	...
	self.top = {
		...
		invertedCssClasses: wsq.provider.parse(self.template.top ? self.template.top.invertedClasses || {} : {}, self.data, self),
	...
	self.bottom = {
		...
		invertedCssClasses: wsq.provider.parse(self.template.bottom ? self.template.bottom.invertedClasses || {} : {}, self.data, self),
	...
	self.middleHeight.subscribe(function (value) {
		...
		self.left.dimensions.height(value);
		self.right.dimensions.height(value);
		self.rightCollapser.dimensions.height(value);
		self.leftCollapser.dimensions.height(value);
	});
	self.middle.dimensions.height(uo(self.middleHeight));
	...
	self.leftCollapser.dimensions.height(uo(self.middle.dimensions.height));
	self.rightCollapser.dimensions.height(uo(self.middle.dimensions.height));
