wsq.controls.layout = function (template, data, parent) {
    ...
    self.leftCollapser.displayClasses = ko.computed(function () {
        if (uo(self.left.collapsed)) {
            return self.leftCollapser.cssCollapsedClasses;
        }
        else {
            return self.leftCollapser.cssClasses;
        }
    });
